...
Scheme
{
	...
	Colors
	{
		...
		"AchievementsDarkGrey"		"60 60 60 255"
		"AchievementsInactiveFG"	"120 120 120 255"
	}
	...
	BaseSettings
	{
		...
		Border.Bright					"230 230 230 255"	// the lit side of a control
		Border.Dark						"60 60 60 198"		// the dark/unlit side of a control
		Border.Selection				"0 0 0 255"			// the additional border color for displaying the default/selected button
		Border.DarkSolid				"60 60 60 255"
		Border.Subtle					"80 80 80 255"

		Button.TextColor				"80 80 80 255"
		Button.BgColor					"180 180 180 255"
		Button.ArmedTextColor			"60 60 60 255"
		Button.ArmedBgColor				"230 230 230 255"	[$WIN32]
		Button.ArmedBgColor				"190 115 0 255"		[$X360]
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"60 60 60 255"
		...
		ComboBoxButton.ArrowColor		"60 60 60 255"
		ComboBoxButton.ArmedArrowColor	"120 120 120 255"
		...
		Frame.BgColor					"120 120 120 250"	[$WIN32]
		Frame.BgColor					"80 80 80 192"		[$X360]
		Frame.OutOfFocusBgColor			"160 160 160 240"	[$WIN32]
		...
		FrameGrip.Color1				"230 230 230 196"
		FrameGrip.Color2				"0 0 0 196"
		FrameTitleButton.FgColor		"230 230 230 196"
		...
		Label.BgColor					"Blank"
		Label.DisabledFgColor1			"120 120 120 255"
		Label.DisabledFgColor2			"60 60 60 255"

		ListPanel.TextColor					"Black"
		ListPanel.TextBgColor				"Blank"
		ListPanel.BgColor					"White"
		ListPanel.SelectedTextColor			"White"
		ListPanel.SelectedBgColor			"180 180 180 204"
		ListPanel.OutOfFocusSelectedTextColor	"Black"
		ListPanel.SelectedOutOfFocusBgColor	"200 200 200 100"
		ListPanel.EmptyListInfoTextColor	"Black"

		Menu.TextColor					"80 80 80 255"
		Menu.BgColor					"230 230 230 255"
		Menu.ArmedTextColor				"White"
		Menu.ArmedBgColor				"120 120 120 255"
		Menu.TextInset					"6"
		...
		ScrollBarButton.BgColor				"200 200 200 255"
		ScrollBarButton.ArmedFgColor		"60 60 60 255"
		ScrollBarButton.ArmedBgColor		"230 230 230 255"
		ScrollBarButton.DepressedFgColor	"60 60 60 255"
		ScrollBarButton.DepressedBgColor	"230 230 230 255"

		ScrollBarSlider.FgColor				"220 220 220 255"			// nob color
		ScrollBarSlider.BgColor				"180 180 180 229"	// slider background color
		...
		SectionedListPanel.SelectedBgColor				"120 120 120 204"
		SectionedListPanel.OutOfFocusSelectedTextColor	"Black"
		SectionedListPanel.OutOfFocusSelectedBgColor	"180 180 180 100"
		...
		TextEntry.SelectedBgColor	"120 120 120 204"
		TextEntry.OutOfFocusSelectedBgColor	"180 180 180 100"
		TextEntry.FocusEdgeColor	"0 0 0 196"

		ToggleButton.SelectedTextColor	"White"

		Tooltip.TextColor			"120 120 120 255"
		Tooltip.BgColor				"235 235 235 255"
